module.exports = {
    ...
    (module ComboDiode (layer F.Cu) (tedit 5B24D78E)
        ...
        ${'' /* footprint reference */}
        (fp_text reference "${p.ref}" (at 0 -1.5) (layer F.SilkS) ${p.ref_hide} (effects (font (size 1.27 1.27) (thickness 0.15))))
        (fp_text value "${ p.param.mark }" (at 0 1.5) (layer F.SilkS) hide (effects (font (size 1.27 1.27) (thickness 0.15))))
        ${''/* diode symbols */}
